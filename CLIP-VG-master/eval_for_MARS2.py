...
import os
os.environ["CUDA_VISIBLE_DEVICES"] = '6'  # batch_size max=768，0、1在用
...
def get_args_parser():
    ...
    parser.add_argument('--eval_model', default='/hy-tmp/zty/VG/CLIP-VG-master/outputs/unc_best_checkpoint.pth', type=str)
